...
이 저장소는 결정론적 TDD 원칙에 따라 AI 에이전트(Codex, Claude Code, Antigravity)와 협업하여 개발된다.
...
- `Proposed`·`Implementing` 논의 문서는 상태 아래에 제안 요약과 목차를 둔다. 필수 항목·묶음·표기 방식은 정본인 `docs/discussion/architecture/topics/implementation-contracts.md`를 따른다.
