...
## 개발자가 달라도, 팀이 달라도, AI 에이전트가 달라도 프로젝트의 개발 기준은 하나 ☝️
...
> 여러 에이전트와 개발자가가 동일한 공통 지침을 기준으로 작업·협업합니다.
>
...
> 전체 사용 흐름은 [사용 가이드](https://github.com/IsthisLee/agentic/blob/main/docs/usage-guide.md)에서 설치부터 동기화까지 단계별로 확인할 수 있습니다.
