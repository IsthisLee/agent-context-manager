...
* **상태:** 채택됨 (Accepted), 일부 정정됨: 결과의 "기능적 중복" 판단과 공식 문서 인용은 [ADR 0009](0009-agent-rule-frontmatter.md)가 정정한다. 일부 대체됨: 파일 이름 `agentic.md`는 [ADR 0013](0013-rename-agent-context-manager.md)이 `agctx.md`로 바꾼다.
* **일자:** 2026-09-13
* **결정자:** 제품 소유자·개발자
