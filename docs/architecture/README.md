...
<!-- agctx-doc-sources-sha256: bd93ac89b90b6bef1c9eeb247c25c6496b6b74ac957eeb85ebf8681a08657fc6 -->
...
flowchart LR
  ...
  subgraph PROJECT["대상 프로젝트"]
    ...
    JCONFIG["agctx.project.json<br/>바인딩한 프로필 · 관리 영역 hash"]
...
프로필 저장소의 `AGENTS.md`가 공통 지침의 정본이고 CLI는 이를 대상 프로젝트의 `AGENTS.md`와 포인터 파일로 적용한다. 에이전트는 프로젝트 파일만 읽으며 agctx는 에이전트를 실행하지 않는다.
