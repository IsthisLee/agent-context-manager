...
- 계획 수립: `src/profile/apply.ts`의 `planFor`<!--s:e2c25e47f058-->, `src/project/plan.ts`의 `planProject`<!--s:b91a2504e3e6-->
...
- 포매터가 다시 쓸 형태 검사: `src/project/analyzer.ts`의 `formatterUnstableLines`<!--s:6b6360574692-->
...
- 충돌 수집과 base 판정: `src/project/plan.ts`의 `planProject`<!--s:b91a2504e3e6-->·`knownBase`<!--s:f7bb47b56e0a-->
