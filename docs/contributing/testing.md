...
<!-- agctx-doc-sources-sha256: 1e47a527847248ebd83f14e4742b8ae9f14fcf9e60ca152189db4a49ee420a11 -->
...
- `PROGRESS.md`의 최근 기록은 `node tools/generate-progress.ts`가 `git log`에서 만든다. `evals/progress.test.ts`는 적힌 줄이 실제 커밋과 맞는지 검사하므로, 커밋할 때마다 다시 만들지 않아도 된다.
