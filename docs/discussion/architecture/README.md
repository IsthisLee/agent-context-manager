...
| 15 | [기존 Git 저장소를 프로필 원천으로 쓰기](topics/existing-repository-source.md) | High | 1·11 | 규칙 파일을 옮기지 않고 `profile.json` 하나만 더해 기존 규칙 저장소를 `profile clone`으로 받고 `pull`로 따라감 | Proposed |
