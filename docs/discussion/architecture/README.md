...
| 16 | [기존 저장소 폴더를 프로필로 연결하기](topics/profile-link.md) | High | 1·11·15 | 규칙 저장소 폴더에서 `profile link` 한 번으로 `profile.json`을 만들고 폴더를 보관함에 연결해 커밋 없이 적용 | Proposed |
