...
예를 들어 사용자가 “회사 프로필을 이 프로젝트에 적용해줘”라고 요청하면 에이전트는 회사 프로필의 정확한 이름과 대상 프로젝트 경로를 확인한 뒤, 적용 결과를 검토할 수 있는 명령으로 실행해야 한다. 프로필나 경로를 추측해 조용히 선택하는 것은 Agentic의 책임 경계가 아니다.
