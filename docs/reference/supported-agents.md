...
<!-- agctx-doc-sources-sha256: d1bb32ff2a37476ede34b6360eef51dae10cb879758b602642a7de0f16457a84 -->
...
| Claude Code | `CLAUDE.md`(`@AGENTS.md`로 `AGENTS.md`를 가져옴), 하위 폴더 `AGENTS.md` 옆의 `CLAUDE.md` 연결 파일 | 시작 폴더와 그 위 폴더의 `CLAUDE.md`·`.claude/CLAUDE.md`·`CLAUDE.local.md`, 그리고 그 파일들이 `@`로 가져오는 파일(최대 4단계). 시작 폴더 밖의 파일을 가져오면 프로젝트마다 처음 한 번 사용자가 승인해야 읽는다 | 세션 기록(`$CLAUDE_CONFIG_DIR/projects`) 또는 probe |
