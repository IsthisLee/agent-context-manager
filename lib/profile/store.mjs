...
import { PROFILE_METADATA_FILE, profileHome } from '../home.mjs';
import { getLocale } from '../i18n/index.mjs';
import { PACKAGE_ROOT } from '../runtime.mjs';

export const SCOPES = ['personal', 'company', 'team', 'workspace'];
...
export function isValidProfileMetadata(metadata, expectedName = null) {
...
export function createProfile(name, scope = 'personal') {
  validateProfileName(name);
