...
import { hasFlag, parseFlag } from '../args.mjs';
import { _ } from '../i18n/index.mjs';
import { readProfile } from '../profile/store.mjs';
import { cliName, PACKAGE_ROOT } from '../runtime.mjs';
import { formatDiff } from './conflicts.mjs';
import { planProject, writePlan } from './plan.mjs';

export function renderProfileAgents(profile, projectName) {
...
export function assertProjectDirectory(targetDir) {
...
export function conflictError(conflicts, targetDir) {
...
export function planFor(name, targetDir, overrides) {
...
export function applyProfile(values) {
 ...
 */
export function syncProject(values) {
