...
import { cliName } from '../runtime.mjs';
import { assertProjectDirectory, boundProfile, planFor, printConflicts, readProjectConfig } from './apply.mjs';
...
import { managedRegion, regionHash, writePlan } from './plan.mjs';
 ...
 */
export function resolveProject(values) {
