...
- `agctx profile setup [--workflow <level>] [--context <level>] [--tdd <level>] [--review <level>] [--verification <level>] [--instructions <level>] [--docs <level>] [--security <level>] [--untrusted <level>] [--language <level>] [<name>]`: Choose the guidance levels written into a profile.
