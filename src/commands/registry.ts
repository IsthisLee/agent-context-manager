...
export const COMMANDS: readonly CommandSpec[] = [
  ...
  { id: 'profile.setup', words: ['profile', 'setup'], args: ['[<name>]'], options: ['workflow', 'context', 'tdd', 'review', 'verification', 'instructions', 'docs', 'security', 'untrusted', 'language'].map(name => ({ name, value: '<level>' })), exitCodes: common, surface: 'profile', changes: 'profile-store', tui: 'main.setup.label', profileMenu: 'actions.setup.label' },
