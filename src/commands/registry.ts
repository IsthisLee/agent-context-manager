...
export const COMMANDS: readonly CommandSpec[] = [
  ...
  { id: 'profile.setup', words: ['profile', 'setup'], args: ['[<name>]'], options: ['harness', 'tdd', 'review', 'verification', 'documentation', 'security'].map(name => ({ name, value: '<level>' })), exitCodes: common, surface: 'profile', changes: 'profile-store', tui: 'main.setup.label', profileMenu: 'actions.setup.label' },
